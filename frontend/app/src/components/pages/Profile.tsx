...
export const Profile = memo(() => {
  ...
  const { handleUpdateUser, name, setName, nickname, setNickname, email, setEmail } = useUpdateUser({ setLoading, setCurrentUser });
 ...
 const { handleUpdatePassword, password, setPassword, passwordConfirmation, setpasswordConfirmation } = useUpdatePassword({ setLoading });
  ...
  return (
    <Flex justify="center" my="12">
      <Box textAlign="center" px="24" py="8" textShadow="2px 2px #000000"  border='1px' borderColor='gray.200' w="xl" mx="8" >
        <Text fontSize="2xl">プロフィール</Text>
          ...
          <Box>
            <Stack>
              <FormControl>
                ...
                <Input size="sm" value={name} onChange={onChangeName} shadow="2xl" aria-label="name"/>
              </FormControl>
              <FormControl>
                <Flex align="center">
                  <FormLabel as="h4">ニックネーム</FormLabel>
                </Flex>
                <Input size="sm" value={nickname} onChange={onChangeNickname} shadow="2xl" aria-label="nickName" />
              </FormControl>
              <FormControl>
                <Flex align="center" >
          ...
          <Box>
            ...
            <Box textAlign="center" mt="6" >
              <AuthButton loading={loading} isDisabled={password === "" || passwordConfirmation === ""} onClick={handleUpdatePassword}>
                パスワード更新
              </AuthButton>
            </Box>
            <Divider mt="6" mb="6" />
            <Box mb="5">
              <Button variant="secoundary" size="sm" py="3" px="14" shadow="2xl" _hover={{opacity: 0.6}}
                textShadow="1px 1px 1px #000000" onClick={onClickHome} >
                ホームに戻る
              </Button>
            </Box>
            <Box>
              <Button variant="danger" size="sm" py="3" px="14" shadow="2xl" _hover={{opacity: 0.6}}
                textShadow="1px 1px 1px #000000" onClick={handleDeleteUser} >
                アカウント削除
              </Button>
            </Box>
          </Box>
